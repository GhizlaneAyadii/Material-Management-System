...
public class MaterielController {
	...
	// fonction permet de rechercher un materiel par date d'affectation
...
// pour cette methode elle permet d'affecter un produit a un enseignant
    @PutMapping("/affecter/{id}")
    public Materiel affecterMateriel(@PathVariable long id,@RequestBody Employees employee){
        //on recupere le materiel par son id
		Materiel materiel = materielService.getMaterielById(id);
		// on remplis le champs employee par l'employe envoye lors de la requete
        materiel.setEmployee(employee);
        // date affectation (aujourd'hui)
